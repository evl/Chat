local frame = CreateFrame("Frame", "EvlChatCopyFrame", UIParent)
frame:SetBackdrop({
...
local scrollArea = CreateFrame("ScrollFrame", "EvlChatCopyFrameScroll", frame, "UIPanelScrollFrameTemplate")
...
local close = CreateFrame("Button", "EvlChatCopyClose", frame, "UIPanelCloseButton")
